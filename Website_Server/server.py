...
DATABASEURI = "postgresql://sina:sina@40.121.89.233/postgres"
...
def adage():
  ...
  #print cost
    ...
    s = ""
    for c in out:
      s = s + "And adult.review like" + "'%%" + c + "%%'"

    y = s[3:]
    cursor = g.conn.execute("SELECT adult.name,adult.url,adult.rating,adult.value,adult.address, adult.review FROM adult where " + y)
  ...
  #print cost
    ...
    cursor = g.conn.execute("SELECT adult.name,adult.url,adult.rating,adult.value,adult.address FROM adult where adult.review like '%% " + age + "%%' ")
    cost = []
  #models = []
    you = []
    for result in cursor:
...
def big():
  ...
  #print cost
    ...
    s = ""
    for c in out:
      s = s + "And bar.review like" + "'%%" + c + "%%'"

    y = s[3:]
    #cursor = g.conn.execute("SELECT * from bar")
    cursor = g.conn.execute("SELECT bar.name,bar.rating,bar.value,bar.address, bar.review FROM bar where " + y)
  #cursor = g.conn.execute("SELECT * FROM test")
  ...
  #print cost
    ...
    cursor = g.conn.execute("SELECT bar.name,bar.rating,bar.value,bar.address, bar.review FROM bar where bar.review like '%% " + age + "%%' ")
    cost = []
  #models = []
    you = []
    for result in cursor:
  ...
  #print cost
    context = dict(data = cost)
  return render_template("big.html",**context)



@app.route('/big1',methods = ['POST'])
def big1():
  age = request.form['age']
  if not age:
    cost = []
  ...
  #print cost
    ...
    s = ""
    for c in out:
      s = s + "And dance.review like" + "'%%" + c + "%%'"

    y = s[3:]
    cursor = g.conn.execute("SELECT dance.name,dance.url,dance.rating,dance.value,dance.address, dance.review FROM dance where " + y)
  #cursor = g.conn.execute("SELECT * FROM test")
  ...
  #print cost
    ...
    cursor = g.conn.execute("SELECT dance.name,dance.url,dance.rating,dance.value,dance.address FROM dance where dance.review like '%% " + age + "%%' ")
    cost = []
  #models = []
    you = []
    for result in cursor:
  ...
  #print cost
    context = dict(data = cost)
  return render_template("big1.html",**context)

@app.route('/big2',methods = ['POST'])
def big2():
  age = request.form['age']
  if not age:
    cost = []
  ...
  #print cost
    ...
    s = ""
    for c in out:
      s = s + "And comedy.review like" + "'%%" + c + "%%'"

    y = s[3:]
    cursor = g.conn.execute("SELECT comedy.name,comedy.url,comedy.rating,comedy.value,comedy.address, comedy.review FROM comedy where " + y)
  #cursor = g.conn.execute("SELECT * FROM test")
  ...
  #print cost
    ...
    cursor = g.conn.execute("SELECT comedy.name,comedy.url,comedy.rating,comedy.value,comedy.address FROM comedy where comedy.review like '%% " + age + "%%' ")
    cost = []
  #models = []
    you = []
    for result in cursor:
  ...
  #print cost
    context = dict(data = cost)
  return render_template("big2.html",**context)
