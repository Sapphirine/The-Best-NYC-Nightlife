...
import requests
page = requests.get('https://www.yelp.com/biz/rentagent-new-york')
tree = html.fromstring(page.content)
reviews = tree.xpath('//meta[@name="description"]/text()')
...
Gist
 ...
 Watch 87
  Star 1,226
 Fork 149 lorien/grab
 Code  Issues 26  Pull requests 4  Wiki  Pulse  Graphs
Branch: master Find file Copy pathgrab/runtest.py
b5d7c82  on Nov 22, 2015
@lorien lorien Refactored handling temporary files and directories in test cases
3 contributors @lorien @standeck @alexey-grom
RawBlameHistory     Executable File  187 lines (161 sloc)  5.28 KB
#!/usr/bin/env python
# coding: utf-8
import unittest
import sys
